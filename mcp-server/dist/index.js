...
// Import tool modules
import { searchTools, handleSemanticSearch, handleSearchExperiences, handleSearchSkills, handleSearchProjects } from './tools/search-tools.js';
import { contactTools, handleGetContactInfo, handleGetAvailabilityStatus, handleGetPreferredContactMethod, handleGenerateIntroductionEmail } from './tools/contact-tools.js';
import { contextTools, handleGetCompleteProfile, handleGetCareerProgression, handleGenerateProfessionalSummary } from './tools/context-tools.js';
// MCP Server setup
...
const connectAndQuery = async (queryFn) => {
