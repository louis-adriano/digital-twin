...
// Tool handlers
export const handleGetContactInfo = async (args) => {
    try {
...
export const handleGetAvailabilityStatus = async (args) => {
    try {
        ...
        if (opportunity_type && availabilityMatrix[opportunity_type]) {
            const details = availabilityMatrix[opportunity_type];
...
export const handleGetPreferredContactMethod = async (args) => {
    try {
        ...
        if (inquiry_type && contactPreferences[inquiry_type]) {
            const prefs = contactPreferences[inquiry_type];
...
export const handleGenerateIntroductionEmail = async (args) => {
    try {
